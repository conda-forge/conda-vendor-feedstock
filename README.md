...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/conda-vendor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13838&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/conda-vendor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `conda-vendor` can be installed with:

```
conda install conda-vendor
```

It is possible to list all of the versions of `conda-vendor` available on your platform with:
